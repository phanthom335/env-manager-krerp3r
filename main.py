    ...
    Env Manager Krerp3r
    ===================
    Developer-friendly CLI that helps you rename projects in seconds.
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Developer-friendly CLI that helps you rename projects in seconds.")
